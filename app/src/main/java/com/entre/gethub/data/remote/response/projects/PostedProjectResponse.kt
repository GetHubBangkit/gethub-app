...
data class PostedProjectResponse(
	...
	data class ProjectsItem(
		...
		@field:SerializedName("selected_user_bid")
		val selectedUserBid: SelectedUserBid,
		...
		val projectTasks: List<ProjectTasksItem>
	)
