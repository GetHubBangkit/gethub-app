...
class SearchProjectAdapter(
    private val projectBidList: List<SearchProjectResponse.ProjectsItem>,
    private val listener: (SearchProjectResponse.ProjectsItem, Int) -> Unit
) :
    RecyclerView.Adapter<SearchProjectAdapter.ViewHolder>() {
    ...
    class ViewHolder(private val binding: ItemProjectRekomendasijobbidBinding) :
        ...
        @RequiresApi(Build.VERSION_CODES.O)
        fun bindItem(projectBid: SearchProjectResponse.ProjectsItem) {
            with(binding) {
