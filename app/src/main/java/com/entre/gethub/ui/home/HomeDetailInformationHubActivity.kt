...
class HomeDetailInformationHubActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val informationHubList = intent.getParcelableArrayListExtra<InformationHubResponse.Data>("information_hub")
